    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btn-flat" form="approveForm" name="approve"><i class="fa fa-check-square-o"></i> Approve</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="denied">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</button>
              <button type="submit" class="btn btn-danger btn-flat" form="denyForm" name="deny"><i class="fa fa-ban"></i> Block</button> <!-- Specify form attribute -->
            </div>
        </div>
    </div>
</div>
